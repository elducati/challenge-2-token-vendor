...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  console.log("\n 🏵 minted 2000 but Sending only 1000 tokens to the vendor...\n");
  //
  ...
  const ownershipTransaction = await vendor.transferOwnership("0x22FECa197670B1EA09AB918A5D5954315Ff42bE7");
  console.log("\n    ✅ confirming...\n");
